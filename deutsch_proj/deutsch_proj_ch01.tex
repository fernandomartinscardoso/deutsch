...
Letter name \textipa{[pe:]}. In words, this letter sounds like p as in \textbf{p}en.
...
Letter name \textipa{[ku:]}. In words, this letter sounds like k as in \textbf{k}ite, and it is always followed by the letter u, forming the sound \textipa{[kv]}.
...
Letter name \textipa{[Er]}. In words, this letter sounds like a guttural r, pronounced at the back of the throat. At the end of words, it sounds like a schwa \textipa{[@]}\footnote{ The "lazy" or "reduced" sound that appears in unstressed syllables, like a as in w\textbf{a}nn\textbf{a}.}.
